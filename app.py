...
user_menu = st.sidebar.radio(
    'Select an Option',
    ('Medal Data','Overall Analysis','Country-wise Analysis','Analyse Athletes')
)

if user_menu == 'Medal Data':
    st.sidebar.header("Medal Data")
    ...
    if selected_year != 'Overall' and selected_country == 'Overall':
        st.title("Medal Data in " + str(selected_year) + " Olympics")
    if selected_year == 'Overall' and selected_country != 'Overall':
...
if user_menu == 'Country-wise Analysis':
    ...
    st.title(selected_country + " Medal Data over the years")
    st.plotly_chart(fig)
